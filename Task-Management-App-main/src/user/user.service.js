...
var UserService = function () {
    ...
    var UserService = _classThis = /** @class */ (function () {
        ...
        UserService_1.prototype.get = function () {
        ...
        UserService_1.prototype.update = function (updateUserDto, userId) {
            // eslint-disable-next-line @typescript-eslint/no-unsafe-return, @typescript-eslint/no-unsafe-assignment
            return this.userRepository.update(userId, updateUserDto);
        };
        UserService_1.prototype.show = function (id) {
            return this.userRepository.findOne({ where: { id: id } });
        };
        UserService_1.prototype.findByEmail = function (email) {
            return this.userRepository.findOne({ where: { email: email } });
        };
        UserService_1.prototype.delete = function (userId) {
